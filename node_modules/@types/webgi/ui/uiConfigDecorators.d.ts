...
export declare function generateUiFolder(label: string, obj: any, params?: any): UiObjectConfig;
export declare function uiFolder(label: string, params?: any): <T extends new (...args: any[]) => any>(constructor: T) => {
    new (...args: any[]): {
        [x: string]: any;
        uiConfig: UiObjectConfig<any>;
    };
} & T;
