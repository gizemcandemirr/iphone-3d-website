import { IRenderTarget, IViewerPlugin, UiObjectConfig } from 'webgi/interfaces';
...
export declare class SSBevelPlugin extends GenericFilterPlugin<SSBevelPass, 'ssBevel', ''> implements IViewerPlugin {
    passId: 'ssBevel';
