...
import { Object3D, Shader, ToneMapping, WebGLRenderer } from 'three';
...
declare class TonemapExtension implements IUiConfigContainer, MaterialExtension {
     ...
     */
    constructor(viewer: ViewerApp, depthTonemap?: boolean, renderToScreen?: boolean);
...
export declare class TonemapPlugin extends GenericExtensionPlugin<TonemapExtension> {
    readonly depthTonemap: boolean;
    static readonly PluginType = "Tonemap";
